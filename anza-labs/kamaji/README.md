...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: edge-24.12.1](https://img.shields.io/badge/AppVersion-edge--24.12.1-informational?style=flat)
...
| image.tag | string | `"edge-24.12.1"` | Tag for the image. |
